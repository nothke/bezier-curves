...
public class BezierCurve : MonoBehaviour
{
    ...
    void Reset()
    {
        drawColor = UnityEngine.Random.ColorHSV(0, 1, 0.9f, 0.9f, 0.9f, 0.9f);
    }
    ...
    public BezierPoint Last() // Nothke: get last point
    {
    ...
    public Vector3 GetTangent(BezierPoint bp1, BezierPoint bp2, float t)
    {
        ...
        Vector3 b = bp1.globalHandle2; // bp1.position + bp1.handle2;
        Vector3 c = bp2.globalHandle1; // bp2.position + bp2.handle1;
